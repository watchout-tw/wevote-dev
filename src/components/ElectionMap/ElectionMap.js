      ...
      <div>
          ...
          <div id="citymap">
              ...
              <div className={`${styles.city} ${this._activeClass('NTC')}`} id="NTC-city">
                <svg x="0px" y="0px" width="507.414px" height="433.167px" viewBox="0 0 507.414 433.167">
                  <g id="NTC">
                    ...
                    <polygon id="NTC-disabled" points="305.64,76.607 244.503,76.607 229.307,91.745 212.974,91.745 197.64,107.245 197.64,120.745
              ...
              <div id="district-info">
                <p id="name">第三東京市第十三選舉區</p>
                <p id="detail">忠孝區、仁愛區、<br/>信義區三里：信一里、信二里、信三里</p>
              </div>
          </div>
      </div>
    )
