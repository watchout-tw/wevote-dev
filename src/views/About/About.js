  ...
  render() {
    ...
    let aboutBlock = (
      <div className={styles.content}>
          ...
          <p>沃草堅持「降低公民參與政治門檻」的初衷，推出「2016立委出任務」，這是一個提供選民了解立委候選人議題表態的網站。我們與許多NGO協力整理過去第八屆立委在立法院中對各重大議題的提案質詢表決，分析出立委及政黨的表態立場；我們也將陸續整理各候選人對相關議題的態度、對推動法案的承諾，提供選民了解候選人的價值理念。</p>
          <p>我們相信，資訊越充足，越能幫助選民在投票時做出正確的判斷。
            我們相信，更多的資訊揭露，更好的選舉文化，將是改變台灣民主政治的關鍵因素。</p>
          <h2>投票一定有風險，立委表現有好有壞，投票前請詳閱「立委出任務」</h2>
    ...
    switch(tabName){
      ...
      case 'FAQ':
          ...
          metaData = {
            title: `資料來源說明-立委出任務-2016立委投票資訊站`,
            description: `關於「2016立委出任務」內容資料之著作權聲明。`,
            meta: {
                charSet: 'utf-8',
                property: {
                  'og:title': `資料來源說明-立委出任務-2016立委投票資訊站`,
      ...
      case 'statement':
          ...
          metaData = {
            title: `著作權聲明-立委出任務-2016立委投票資訊站`,
            description: `關於「2016立委出任務」內容資料之著作權聲明。`,
            meta: {
                charSet: 'utf-8',
                property: {
                  'og:title': `著作權聲明-立委出任務-2016立委投票資訊站`,
                  'og:description': `關於「2016立委出任務」內容資料之著作權聲明。`
                }
            }
          };
      ...
      default: 
          ...
          metaData = {
            title: `關於立委出任務-立委出任務-2016立委投票資訊站`,
            description: `「2016立委出任務」是一個提供選民了解立委候選人議題表態的網站。我們整理分析第八屆立委對重大議題的表態立場，提供選民了解候選人的價值理念。 「2016立委出任務」希望能夠做到更多的資訊揭露，改變台灣民主政治。`,
            meta: {
                charSet: 'utf-8',
                property: {
                  'og:title': `關於立委出任務-立委出任務-2016立委投票資訊站`,
                  'og:description': `「2016立委出任務」是一個提供選民了解立委候選人議題表態的網站。我們整理分析第八屆立委對重大議題的表態立場，提供選民了解候選人的價值理念。 「2016立委出任務」希望能夠做到更多的資訊揭露，改變台灣民主政治。`
                }
            }
          };
          break;
