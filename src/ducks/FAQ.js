   ...
   "data" : [
    {
      ...
      "answer" : [ "針對本網站相關議題，我們將每位立委（包含區域立委和不分區立委）在立法院內院會、委員會、公聽會等職務行為，依照「發言、提案、表決」進行分類，並邀請長期關心各議題的NGO團體參與判斷各立委的每項表態資訊屬於「支持、反對、模糊」。我們希望提供這些資訊，讓每位選民可以了解這些立委的價值選擇，是否符合你的期待。","同時，我們將依照各立委表態時所屬的政黨，整理分析成為政黨的表態結果，希望藉此提供選民在政黨票投票時的判斷參考。","以上的資料來源都來自立法院官方公布資料，包含立法院公報和議案。" ]
    },
    {
    ...
    {
      "question" : "立委「應表態未表態」的資料是什麼意思？",
      "answer" : [ "依照立法程序，法案經一讀後會交付委員會審查，而委員會應該是立委討論法案最激烈的階段，也應該最能看出立委的表態。","立法院中有八個委員會：「內政、外交國防、財政、經濟、教育文化、交通、司法法制、社福衛環」。一個法案通常會分發到一或多個委員會進行審查，而每個立委也都會加入其中一個委員會。所以我們認為立委有責任對其所屬委員會中審查的法案，進行「發言、提案、表決」等表態，如果沒有就屬於「應表態未表態」。"]
    },
    {
