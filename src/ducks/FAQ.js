const initialState = {
   "data" : [
    ...
    },
    {
      ...
      "answer" : [ "我們認為立委在立法院內在各重大議題上的態度及優先通過法案的主張是非常重要的資料，所以我們以這兩項內容製作政黨表態承諾書。從11月27日(五) 中選會登記確定各政黨名單後，我們已經在11月30日(一)以雙掛號寄出表態承諾書，邀請各政黨加入回覆。截至12月4日網站更新前，已有自由台灣黨、時代力量、綠社盟回覆，我們歡迎每個政黨進行表態承諾的回覆。",
