...
const SET_PARTY_FILTER = 'SET_PARTY_FILTER';
...
export default function reducer(state = initialState, action = {}) {
  ...
  switch (action.type) {
    ...
    case SET_PARTY_FILTER:
      ...
      if(partyPositions[action.name]){
        return {
            partyFilter: action.name,
            data: partyPositions[action.name]
        };
...
export function setPartyFilter(value) {
  return {
