...
const FAQ = {
   "data" : [
    ...
    },
    {
      ...
      "answer" : [ "我們認為立委在立法院內在各重大議題上的態度及優先通過法案的主張是非常重要的資料，所以我們以這兩項內容製作政黨表態承諾書。從11月27日（五）中選會登記確定各政黨名單後，我們已經在11月30日（一）及12月15日（二），以雙掛號寄出兩次表態承諾書，邀請各政黨加入回覆。",
                   `截至網站更新前（${meta.updateTimeFAQ}），經過陸續幾波調查，得到自由台灣黨、時代力量、綠社盟、樹黨、大愛憲改聯盟、台聯等政黨的積極回覆，我們歡迎每個政黨進行表態承諾的回覆。`,
